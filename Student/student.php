    ...
    <div class="container">
        ...
        <div class="row marketing">
            <div class="col-lg-12">
                ...
                <h3>Ask question</h3>
                <form class="">
                    <input type="text" class="form-control" placeholder="?" style="display:inline; width:85%">
                    <input type="submit" class="btn btn-success knapp" value="Ask" style="display:inline; width:14%">
                </form>
           </div>
       </div>
